    ...
    return (
        <div className="bg-purple-300 pt-24 h-screen">
            <div className="justify-around h-8 w-[500px] bg-white m-auto flex flex-row">
                ...
                <div className="flex text-sm mt-2 bg-slate-100 text-center w-[130px]  h-[20px]">
            ...
            <div className="w-[500px] h-[450px] pl-5 bg-rose-400 m-auto pt-5">
                <div className="bg-white h-auto w-80">
                    <h1 className="text-left ml-6 font-bold mt-2 text-black mb-9 text-2xl">Sign up</h1>
                    <form onSubmit={submitHandler}>
                        ...
                        <label htmlFor="email" className="ml-8 font-bold">Email address:
                            <input
                                type="email"
                                name="email"
                                className="my-auto mb-5 ml-8 m-2 bg-stone-200 text-center"
                        ...
                        <button type="submit" className="h-auto w-20 ml-9 text-center bg-orange-400 m-2 text-black">Register</button>
                    </form>
                </div>
            </div>
        </div>
