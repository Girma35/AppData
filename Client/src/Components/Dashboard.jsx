    ...
    return (
        <div className="bg-purple-300 w-full min-h-screen p-4">
            ...
            <div className="w-full bg-white h-20 border flex items-center justify-between px-4">
                <p className="text-sm border"><Link to="/NewRecipePages">Create new recipe</Link></p>
            ...
            <div className="w-full max-w-[1480px] h-auto bg-rose-400 mx-auto ">
               
                <div className="flex sm:hidden md:block  m-auto bg-white text-black w-full max-w-[1480px]">
                    <ChooseItem />
                </div>
